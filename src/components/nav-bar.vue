        ...
        <div class="d-flex align-items-center">
          ...
          <div class="dropdown ms-1 topbar-head-dropdown header-item">
            ...
            <div class="dropdown-menu dropdown-menu-end">
              <b-link href="javascript:void(0);" v-for="(entry, i) in languages" :key="`Lang${i}`" :value="entry" @click="setLanguage(entry.language, entry.title, entry.flag)" :class="{ active: lan === entry.language }" class="dropdown-item notify-item language py-2" data-lang="en" title="English">
                ...
                <div class="p-2">
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div class="flex-1">
                        <h6 class="mt-0 mb-1 fs-14">
                          <b-link href="/ecommerce/product-details" class="text-reset">Branded T-Shirts</b-link>
                        </h6>
                  ...
                  <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="flex-1">
                        <h6 class="mt-0 mb-1 fs-14">
                          <b-link href="/ecommerce/product-details" class="text-reset"> Borosil Paper Cup</b-link>
                        </h6>
                  ...
                  <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="flex-1">
                        <h6 class="mt-0 mb-1 fs-14">
                          <b-link href="/ecommerce/product-details" class="text-reset">Gray Styled T-Shirt</b-link>
                        </h6>
          ...
          <div class="ms-1 header-item d-none d-sm-flex">
            <b-button type="button" variant="ghost-secondary" class="btn-icon btn-topbar rounded-circle" data-toggle="fullscreen" @click="initFullScreen">
          ...
          <div class="dropdown ms-sm-3 header-item topbar-user">
            ...
            <div class="dropdown-menu dropdown-menu-end">
              ...
              <router-link class="dropdown-item" to="/pages/profile-setting"
                ><b-badge variant="soft-success" class="bg-soft-success text-success mt-1 float-end">New</b-badge><i class="mdi mdi-cog-outline text-muted fs-16 align-middle me-1"></i>
